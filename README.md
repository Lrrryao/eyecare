...
这是一个专为 Linux 系统设计的自动化健康提醒系统，包含眼睛休息提醒和喝水提醒功能。支持 Fedora、Ubuntu 等主流 Linux 发行版。

## ✨ 功能特点

- 🕐 **定时提醒**: 眼睛休息每40分钟提醒一次，喝水每30分钟提醒一次
- 🖥️ **图形管理界面**: 提供直观的图形界面管理程序
- 🔔 **系统通知**: 在 Wayland 环境下使用系统通知，在 X11 环境下使用系统托盘
- ⚙️ **实时配置**: 通过图形界面实时调整提醒间隔，立即生效
- 🚀 **开机自启**: 支持 systemd 用户服务开机自启动
- 📱 **桌面快捷方式**: 可安装桌面快捷方式，随时启动管理界面
- 🐧 **Linux 优化**: 专为 Linux 环境优化，支持 Wayland 和 X11
